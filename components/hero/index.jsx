    ...
    <section className="relative flex min-h-[92vh] items-center overflow-hidden">
      ...
      <div className="relative mx-auto w-full max-w-7xl px-4 pt-28 pb-16 sm:px-6 lg:px-8">
        <div className="max-w-2xl">
          <span
            className="hero-anim inline-flex items-center gap-2 rounded-full border border-white/20 bg-white/10 px-4 py-1.5 text-sm font-medium text-white backdrop-blur-sm"
          ...
          >
            Güneşin Gücünü <span className="text-accent">Enerjiye</span>{" "}
            Dönüştürüyoruz
          </h1>
          ...
          >
            Çatı ve arazi GES, sulama sistemleri, araç şarj istasyonları ve
            enerji depolama çözümlerinde anahtar teslim hizmet. Enerjinizi
            güneşten üretin, geleceğe yatırım yapın.
          </p>
